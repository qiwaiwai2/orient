...
export function saveGpsDataLog(competitionId,competitionItemId,groupId){ //生成gps数据文件
    return axios({
        method:"post",
        url:"along/CrossSportsmanController/saveGpsDataLog",
        data:JSON.stringify({
            competitionId:competitionId,
            competitionItemId:competitionItemId,
            groupId:groupId,
...
export function downloadBatchStart(){ //下载批次模板
    return axios.post('along/CrossCompetitionItemsController/downloadBatchStart')
}
export function clearDrawLots(competitionId,competitionItemId){ //清除抽签结果
    return axios({
        method:"post",
        url:"along/CrossCompetitionItemsController/clearDrawLots",
        data:QS.stringify({
            competitionId:competitionId,
            competitionItemId:competitionItemId
        })
...
export function uploadSportsBatch(competitionId,competitionItemId){ //清除抽签结果
    return axios({
        method:"post",
...
export function clearSportsmanList(competitionId){ //清除人员数据
    return axios({
        method:"post",
        url:"along/CrossSportsmanController/clearSportsmanList",
        data:QS.stringify({
            competitionId:competitionId,
        })
    })
