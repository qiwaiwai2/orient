<template>
    <div class="game">
        <div class="game_head">
            <a-input v-model="searchInfo" @pressEnter="search" placeholder="请输入单位名称/单位简称"/>
        ...
        <a-modal
            ...
            >
            <div class="game_name">
                <span style="display:inline-block;width:100px;text-align:right">单位（中文）：</span><a-input v-model="chineseNation" placeholder="请输入"/>
            </div>
            <div class="game_local">
                <span style="display:inline-block;width:100px;text-align:right">单位（英文）：</span><a-input v-model="EnglishNation" placeholder="请输入"/>
            </div>
            <div class="game_local">
                <span style="display:inline-block;width:100px;text-align:right">单位简称 ：</span><a-input v-model="nationCode" placeholder="请输入"/>
            </div>
            <div class="game_local">
                <span style="display:inline-block;width:100px;text-align:right">单位logo ：</span>
